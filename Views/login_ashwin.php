...
<div id="full-screen" class="col-md-12 login_main_page">
  ...
  <header id="header" class="fixed-top">
       <div class=" ">
           <div class="row ">
          <div class="col-sm-2">&#x2003;
      <a href="<?php echo base_url('Billing'); ?>"><img class="img-responsive" title="HOSPITAL" src="<?php echo base_url() ?>/uploads/banner/logo.png" alt="logo" ></a>
    </div>
                <div class="col-sm-8">
                  <div class="row">
       <div class="col-sm-10"> <i class="bi bi-envelope"></i> <a href="https://www.ashwinhospital.com/">https://www.ashwinhospital.com/</a> &#x2003;<br/>
        <i class="bi bi-phone"></i> +91 97877 30400</div>
        <div class="col-sm-2"> </div>
          </div>
           <h1 class="logo"><a >Ashwin Hospital </a></h1>
      </div>
...
<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('uploads/banner/banner1.jpg'); ?>" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="<?php echo base_url('uploads/banner/banner2.jpg'); ?>" class="d-block w-100" alt="...">
      
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('uploads/banner/banner3.jpg'); ?>" class="d-block w-100" alt="...">
    </div>
  </div>
...
<div id="right_column" >
  <div class="login_form12">
    <form action="<?= base_url('/login_post')?>" class="form" method="post" name="login_form12" id="login_form12">

      <div class="login-space">
           <div class="login1">
      <div class="group">
        <label for="user" class="label">Username</label>
        <input type="text" name="user_name" class="input" id="user_name" placeholder=" ">
 ...
 <div class="input-group-append input" style="width: 64px;">
            ...
            <div class="input-group mb-3" style="flex-wrap: initial;">
                  <input type="UserCaptchaCode" maxlength="4" id="UserCaptchaCode" name="UserCaptchaCode" class="input" placeholder=" ">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-3 col-md-6 footer-contact">
            <h3>Ashwin Hospital </h3>
            <p>1, Near G P Theatre, Alamu Nagar, Sathy Main Road, Gandhipuram, Coimbatore &#x2013; 641012<br><br>
              <strong>Phone:</strong>   0422 2525252, 4389966<br>
              <strong>Mail:</strong> <a href="mailto:ashwinhospitalcbe@gmail.com">ashwinhospitalcbe@gmail.com</a><br>
            </p>
          </div>
